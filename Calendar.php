...
<body class="bg-light">
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark bg-gradient" id="topNavBar">
        <div class="container">
            ...
            Peminjaman Aula Kantor Kelurahan Bahu
            </a>

            <div>
                <b class="text-light">Kelompok 3 Dasi</b>
            </div>
        </div>
    </nav>
                        ...
                        <div class="container-fluid">
                            <form action="save_schedule.php" method="post" id="schedule-form">
                                ...
                                <div class="form-group mb-2">
                                    <label for="title" class="control-label">Keterangan</label>
                                ...
                                <div class="form-group mb-2">
                                    <label for="start_datetime" class="control-label">Awal Peminjaman</label>
                                    <input type="datetime-local" class="form-control form-control-sm rounded-0" name="start_datetime" id="start_datetime" required>
                                </div>
                                <div class="form-group mb-2">
                                    <label for="end_datetime" class="control-label">Akhir Peminjaman</label>
                ...
                <div class="modal-body rounded-0">
                    <div class="container-fluid">
                        <dl>
                            ...
                            <dt class="text-muted">Awal Peminjaman</dt>
                            <dd id="start" class=""></dd>
                            <dt class="text-muted">Akhir Peminjaman</dt>
                            <dd id="end" class=""></dd>
                        </dl>
                    </div>
                </div>
